...
import com.dxc.glic.api.GlicApi;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	if(!deptRepo.existsById(GlicApi.dId))
		{
			throw new EmployeeException(
	...
	public Employee getEmpId(int employeeId) throws EmployeeException {
		if ((employeeRepo.existsById(employeeId)) == false) {
			throw new EmployeeException("An Employee with the Emp code " + employeeId + " doesnot exists!");
		}
